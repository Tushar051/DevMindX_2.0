...
export function SignupPage() {
  ...
  return (
    ...
    >
      ...
      <Card className="w-full max-w-md bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl relative z-10 mt-16">
        <div
        ...
        <CardHeader className="text-center relative z-10">
          <CardTitle className="text-3xl font-bold text-white mb-2">JOIN THE FUTURE</CardTitle>
          ...
          {isVerifying ? (
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="w-full bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300 backdrop-blur-sm"
                  />
                </div>
              </div>
              <Button 
              ...
              <Button
                ...
                className="w-full border-white/20 text-gray-300 hover:text-white hover:border-white/40 transition-all duration-300"
              >
            ...
            <>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="w-full bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300 backdrop-blur-sm pr-12"
                    />
                    <button
                      type="button"
              ...
              <Button 
                ...
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : ""} 
                CREATE ACCOUNT
              </Button>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button 
                  ...
                  className="border-white/20 text-gray-300 hover:text-white hover:border-white/40 hover:bg-white/5 transition-all duration-300"
                >
