...
- Choose profession: **Electrician** or **Mechanic**
- Set availability and get job bookings from customers
- View, accept, or decline booking requests
- Track completed jobs

### 👨‍💼 Customers
- Log in using **Google Sign-In** (OAuth2)
- Select worker type (Electrician/Mechanic)
- View **nearby available professionals**
- Book instantly and track job status
...
| Database     | MongoDB                           |
| Auth         | Google OAuth2 (for Customers), Manual Registration (for Workers) |
| APIs         | RESTful APIs using Spring         |
| Deployment   | Cloud-Ready (Docker + CI/CD Supported) |

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## 🔄 How It Works

### ➤ Worker Flow (Electrician/Mechanic)
1. Click **Register as Worker**
2. Enter Aadhaar, name, age, email, phone, and password
3. Choose role: **Electrician** or **Mechanic**
4. Login to view job requests and manage profile
5. Accept jobs, mark them complete, track income

### ➤ Customer Flow
1. Login with **Google**
2. Select **Electrician** or **Mechanic**
3. See available workers near your location
4. Click to **book instantly**
5. Track job status, get notified when accepted
...
> Payment suggestions are **AI/ML powered** using factors such as:

- 📍 **Distance**: how far the worker traveled to the customer
- ⏱️ **Total time taken** for the service (including travel)
- 🔧 **Accessories/parts needed** (e.g., wire, tools, oil, bulbs)
- 💵 **Worker's base pay** (set per profession)
- 📊 Demand/surge logic (optional in future)

Once calculated, the app will **recommend a fair price**.
...
- ✅ Payment is locked only after mutual agreement
- 🔒 Funds released after job completion (escrow-like safety)
...
| Low/No commission for workers         | ✅           | ❌ (high cut)    | ❌       | ❌      |
| Role-specific dashboards              | ✅           | ✅               | ❌       | ❌      |
| Emergency support system              | ✅           | ❌               | ❌       | ❌      |
| Real-time availability & tracking     | ✅           | ⚠️               | ❌       | ❌      |
| AI-based smart payment calculation       | ✅        | ❌               | ❌       | ❌      |
| In-app bargaining/negotiation            | ✅        | ❌               | ❌       | ❌      |
| Live payment tracking and escrow release | ✅        | ❌               | ❌       | ❌      |
...
- 💡 A real-world impact project that can **genuinely help people**
...
- 📍 Google Maps API for location-based worker suggestions  
- 📱 Mobile app with React Native  
- ⭐ Customer reviews + rating system  
- 🧾 Invoice generation and tracking  
- 📦 Multi-service support (plumbers, AC repair, etc.)
...
### 🌟 Let’s Build for Bharat. Let’s Build for Real People.
