      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-4">
            ...
            <Button onClick={() => navigate('/generator')} className="bg-purple-600 hover:bg-purple-700">
                  ...
                  <CardFooter className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button 
                        variant="outline"
                        size="sm"
                        className="border-gray-600 hover:bg-gray-700 text-purple-400 hover:text-purple-300"
                        onClick={() => {
                          // Navigate to generator with project ID
