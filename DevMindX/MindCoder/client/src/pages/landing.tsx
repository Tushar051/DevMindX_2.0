  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Button onClick={() => navigate('/generator')} variant="ghost" className="text-gray-300 hover:text-white">
                AI Generator
              </Button>
          ...
          <div className="flex flex-col gap-4 items-center">
            <div className="flex flex-col sm:flex-row gap-4">
              <SlideButton
                ...
                className="[&>*]:!text-purple-600 hover:[&>*]:!text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
              >
      ...
      <section id="ai-models" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Powered by Advanced AI Models</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our AI Generator uses Google's Gemini for intelligent code generation, with additional models available for specialized tasks
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            ...
            <Card className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border-blue-500/50 hover:border-blue-400/70 transition-colors relative overflow-hidden shadow-lg">
              <div className="absolute top-0 right-0 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 text-xs font-bold">AI GENERATOR</div>
              <CardHeader>
                <div className="flex justify-between items-start mb-2">
                  <div>
