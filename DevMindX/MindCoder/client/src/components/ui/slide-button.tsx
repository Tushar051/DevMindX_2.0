...
const SlideButton = forwardRef<HTMLButtonElement, SlideButtonProps>( 
  ({ className, children, onComplete, ...props }, ref) => { 
    ...
    return ( 
      <motion.div 
        ...
        className="shadow-button-inset dark:shadow-button-inset-dark relative flex h-12 items-center justify-center rounded-full bg-gray-100" 
      > 
        {!completed && ( 
          <>
            <motion.div 
            ...
            /> 
            <span className="relative z-10 text-white font-medium px-6 ml-6">
              {children || "Launch AI IDE"}
            </span>
          </>
        )} 
          ...
          {!completed && ( 
            ...
            > 
              <Button 
                ...
                size="icon" 
                className={cn( 
                  "shadow-button rounded-full drop-shadow-xl bg-blue-600 hover:bg-blue-700", 
          ...
          {completed && ( 
            ...
            > 
              <Button 
                ...
                {...props} 
                className={cn( 
                  "size-full rounded-full transition-all duration-300 bg-blue-600 hover:bg-blue-700", 
                  className 
                )} 
              > 
